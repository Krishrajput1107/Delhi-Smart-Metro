...
void dijkstra(ll src, ll dest)
{
    ...
    disp(src, dest, par);
    // Print the cost of the journey
    cout << "Total cost of the journey: Rs. " << dist[dest] << endl;
}
...
{
	string s;
	addedge("blueline.txt",4);
	addedge("yellowline.txt",4);
	addedge("redline.txt",4);
	addedge("greenline.txt",4);
	addedge("violetline.txt",4);
	addedge("bluext.txt",4);
	addedge("orangeline.txt",4);
}
void bfs(ll src, ll dest)
{
    ...
    disp(src, dest, par);
    // Print the cost of the journey
    cout << "Total cost of the journey: Rs. " << par[dest] << endl;
}
int main()
{
		...
		switch(dec)
		{
			case 1:
					do
					{
						...
						src=M[source];
						dest=M[destination];
						cout<<"1.For most convenient path(least interchange )\n";
						cout<<"2.For shortest path(Max Interchanges)";
						cin>>choice;
						switch(choice)
						{
